    ...
    class ClassGlobal
    {
        ...
        public static void getAllTables(ToolStripStatusLabel InfosToolStripStatusLabel)
        {
            try
            {
                ...
                InfosToolStripStatusLabel.Text = ClassGlobal.resManager.GetString("Connexion_To_DB_Success", ClassGlobal.cul); //"Connexion à la base de données établie.";
            ...
            catch (Exception ex)
            {
                ...
                InfosToolStripStatusLabel.Text = ClassGlobal.resManager.GetString("Connexion_To_DB_Error", ClassGlobal.cul); //"Erreur de connexion à la base de données !"; // "Erreur : " + ex.Message;
