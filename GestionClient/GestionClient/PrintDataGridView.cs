/*
 * Le code inclus dans cette classe est extrait d'un exemple sur internet + modifié pour simplifier son utilisation.
 * 
...
namespace GestionClient
{
    ...
    {
        // méthode printDataGridViewPage
        public static void printDataGridViewPage(System.Drawing.Printing.PrintPageEventArgs e, DataGridView dataGridView1, String summary)
        {
            try
            {
            ...
            {
                MessageBox.Show(exc.Message, ClassGlobal.AppName, MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
    }
}
